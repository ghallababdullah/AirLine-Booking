        ...
        <div className="admin-dashboard-container">
            <div className="admin-dashboard-card">
                ...
                <div className="admin-dashboard-tabs">
                    ...
                    {isAdmin && (
                        <button className={activeTab === "add-user" ? "active" : ""} onClick={() => navigate("/special-register")}>
                            Add a user
                        </button>)
                    }
                ...
                <div className="admin-dashboard-content">
                    {activeTab === "bookings" ? (
                                ...
                                bookings.map(booking => (
                                    <div key={booking.id} className="admin-booking-card">
                                        <div className="admin-booking-header">
                                            ...
                                            <div className={`admin-booking-status ${booking.status?.toLowerCase() || "unknown"}`}>
                        ...
                        <div className="admin-airports-list">
                            ...
                            <h2> editing airport restricted for admins</h2>
                        </div>
                    )}
                </div>
