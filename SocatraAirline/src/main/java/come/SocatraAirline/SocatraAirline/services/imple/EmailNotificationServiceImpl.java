...
import come.SocatraAirline.SocatraAirline.repo.EmailNotificationRepo;
...
public class EmailNotificationServiceImpl implements come.SocatraAirline.SocatraAirline.services.EmailNotificationService {
    ...
    public void sendBookingTicketEmail(Booking booking) {
        log.info("Inside sendBookingTicket Email()");
    ...
    public void sendWelcomeEmail(User user) {
        ...
        String subject = "Welcome to Socotra Airline!";
